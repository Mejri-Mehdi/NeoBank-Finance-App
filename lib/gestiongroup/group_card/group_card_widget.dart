...
class GroupCardWidget extends StatefulWidget {
  const GroupCardWidget({
    ...
    bool? is_owed,
        ...
        this.avatars = avatars ?? 'smiling man, woman portrait, happy face',
        this.member_count = member_count ?? '+4 members',
        this.name = name ?? 'Trip to Bali',
        this.status_text = status_text ?? 'You owe',
        this.is_owed = is_owed ?? false;
