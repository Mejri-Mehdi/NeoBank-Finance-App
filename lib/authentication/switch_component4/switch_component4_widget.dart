...
import 'switch_component4_model.dart';
export 'switch_component4_model.dart';

class SwitchComponent4Widget extends StatefulWidget {
  const SwitchComponent4Widget({
    super.key,
    bool? label,
    String? variant,
    bool? active,
  ...
  @override
  State<SwitchComponent4Widget> createState() => _SwitchComponent4WidgetState();
}

class _SwitchComponent4WidgetState extends State<SwitchComponent4Widget> {
  late SwitchComponent4Model _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => SwitchComponent4Model());
