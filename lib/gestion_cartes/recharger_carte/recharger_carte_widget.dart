...
import 'recharger_carte_model.dart';
export 'recharger_carte_model.dart';

/// Create a premium, compact "Recharger Carte" (Top-Up Card) screen for a
/// Fintech app.
///
/// Use a clean white background with vibrant purple primary accents.
/// 1. App Bar: Title "Recharger" with a back button.
/// 2. Header: A prominent text saying "Montant à ajouter" (Amount to add).
/// 3. Input Field: A very large, centered TextField for typing the amount.
/// The text should be huge, bold, and purple. Include "TND" as a suffix
/// outside or inside the field. Use a number pad keyboard type.
/// 4. Quick Amounts: A row of 3 rounded, light purple "chip" buttons below
/// the input field for quick selection: "+50 TND", "+100 TND", "+200 TND".
/// 5. Confirmation Button: A large, pill-shaped, vibrant purple gradient
/// button at the bottom labeled "Confirmer le rechargement".
...
class RechargerCarteWidget extends StatefulWidget {
  ...
  @override
  State<RechargerCarteWidget> createState() => _RechargerCarteWidgetState();
}

class _RechargerCarteWidgetState extends State<RechargerCarteWidget> {
  late RechargerCarteModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => RechargerCarteModel());
